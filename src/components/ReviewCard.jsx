const ReviewCard = ({ review }) => {
  return (
    <div className="w-1/2 shadow-lg border-indigo-500 border-2 border-opacity-20 rounded-2xl">
      <div className="w-full h-2/3 border-b-2 border-indigo-500 border-opacity-20 p-5">
        <p className=" text-justify line-clamp-5">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Dignissimos
          error veritatis sunt! Numquam voluptas itaque tempora laboriosam
          soluta sequi animi temporibus harum, explicabo, asperiores quis amet
          sed reiciendis perferendis est?
        </p>
      </div>
